...
if __name__ == '__main__':
    ...
    # Patched (spongeMAG): build contig_lens from args.contig_file rather than
    # from the bin directory. On the second post-process pass, `path` points to
    # the already-filtered bins which only contain a subset of namelist's
    # contigs, causing a KeyError here on any contig that was pruned.
    contig_lens = {}
